...
protected:
    ...
    void paintEvent(QPaintEvent *) override
    {
        ...
        if (hasFocus() && keyboardFocus_)
        {
            ...
            p.drawRoundedRect(QRectF(rect()).adjusted(1.5, 1.5, -1.5, -1.5), 4,
                              4);
        }
    ...
    : QWidget(window)
{
    ...
    this->setStyleSheet(R"(
        ...
        #choppaTitlebar QLabel { background: transparent; border: none; color: #999999; font: 700 12px 'Satoshi'; }
        #choppaTitlebar QLabel#brand { color: white; font: 700 15px 'Satoshi'; }
        #choppaTitlebar QPushButton { border: 1px solid transparent; border-radius: 6px; background: transparent; color: #cccccc; padding: 0; font: 700 18px 'Satoshi'; }
